import os
os.environ["PATH"] += os.pathsep + r"E:\poppler\Release-24.08.0-0\poppler-24.08.0\Library\bin"
os.environ["PATH"] += os.pathsep + r"E:\Tesseract-OCR"
...
if uploaded_file:
    ...
    text = load_pdf(os.path.join(pdfs_directory, uploaded_file.name))
